insert into produto (id, nome, preco, descricao) values (1, 'Kindle', 599.0, 'Conheça o novo Kindle, agora com iluminação embutida ajustável, que permite que você leia em ambientes abertos ou fechados, a qualquer hora do dia.');
